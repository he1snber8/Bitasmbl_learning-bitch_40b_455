...
```bash
bitasmbl pull --repoUrl https://github.com/he1snber8/Bitasmbl_learning-bitch_40b_455 --appId 455 --repoId 315
```

## 3) Enter into the main directory and start coding!

```bash
cd Bitasmbl_learning-bitch_40b_455
```
...
{"Requirement":"Define learning models","Paths":["**/app/models/**","**/src/models/**","**/app/domain/**"]}
